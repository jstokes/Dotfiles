...
(defun dotspacemacs/user-config ()
  ...
  (with-eval-after-load 'clojure-mode
    ...
    (put-clojure-indent 'manifold.deferred/success-deferred 2)
    (put-clojure-indent 'd/success-deferred 2)
